    ...
    <div class="row align-items-center">
        ...
        <div class="col-auto">
            <div class="dropdown">
                ...
                {{-- If you are the owner of the post, then display the edi and delete --}}
                ...
                @else
                    {{--  If you are not the owner of the post, then display the 'Unfollow' button instead --}}
                    <div class="dropdown-menu">
                        @if ($post->user->isFollowed())
                            <form action="{{route('follow.destroy', $post->user->id)}}" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="deopdown-item text-danger">Unfollow</button>
                            </form>
                        @else
